...
extern int	gtm_pq_getkeepalivesidle(Port *port);
extern int	gtm_pq_getkeepalivesinterval(Port *port);
extern int	gtm_pq_getkeepalivescount(Port *port);

extern int	gtm_pq_setkeepalivesidle(int idle, Port *port);
extern int	gtm_pq_setkeepalivesinterval(int interval, Port *port);
extern int	gtm_pq_setkeepalivescount(int count, Port *port);
