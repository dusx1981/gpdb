 ...
 * passed.
 *
 * Note that any cells removed by gtm_list_truncate() are NOT gtm_pfree'd.
 */
gtm_List *
 ...
 *
 * The cell is gtm_pfree'd, as is the gtm_List header if this was the last gtm_member.
 */
gtm_List *
